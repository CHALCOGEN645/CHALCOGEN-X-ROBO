...
class Config(object):
    ...
    OWNER_ID = "6536914119" # If you dont know, run the bot and do /id in your private chat with it, also an integer
    
    SUPPORT_CHAT = "penguin_x_chat"  # Your own group for support, do not add the @
    START_IMG = ""
